...
docker run --net test1 -d -it --name test1 --user 0 -p 10.1.1.12:45645:6901 -e VNC_RESOLUTION=800x600 atr2600/zenmap-vnc-ubuntu
docker run --net test2 -d -it --name test2 --user 0 -p 10.1.1.12:45678:6901 -e VNC_RESOLUTION=800x600 atr2600/zenmap-vnc-ubuntu
